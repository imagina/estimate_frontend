<template>
  <q-layout view="lHh LpR lff" v-if="$store.state.app.active">
    <!-- HEADER -->
...
<script>
  /*Components*/
  import adminHeader from 'src/components/master/frontend/header'
  import adminFooter from 'src/components/master/frontend/footer'
